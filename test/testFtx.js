...
// const { allFtxData } = require('./service/ftx')
// const { allFtxData } = require('./service/volatility')
// const { allFtxData } = require('./service/quickLong')
const { allFtxData } = require('./service/quickShort')

async function main() {
  // const data = await getMonthlyCandles();
  const data = allFtxData()
  ...
  console.log(`最后的盈利变化是 ${results[results.length - 1]} ${results[0]}`);
